...
"""generate_spellcheck_config.py: Simple helper script for auto generating the spell check config
   ...
   keyboard subtype, and Android ignores the VoxKB spell checker unless it declares the currently active system
   ...
   Before running this script, make sure that exactly one device is connected and that VoxKB Debug (0.4.0-alpha1
...
PULL_CMD_INPUT = """run-as com.voxkb.debug
...
<spell-checker xmlns:android="http://schemas.android.com/apk/res/android"
    android:label="@string/voxkb_app_name"
    android:settingsActivity="com.voxkb.SettingsLauncherAlias">
"""
