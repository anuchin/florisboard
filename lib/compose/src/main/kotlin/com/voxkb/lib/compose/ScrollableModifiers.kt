...
fun Modifier.voxkbVerticalScroll(
    ...
    if (showScrollbar) {
        verticalScroll(scrollState).voxkbScrollbar(scrollState, scrollbarWidth, isVertical = true)
    } else {
        verticalScroll(scrollState)
    }
}

fun Modifier.voxkbHorizontalScroll(
    state: ScrollState? = null,
    showScrollbar: Boolean = true,
    ...
    val scrollState = state ?: rememberScrollState()
    if (showScrollbar) {
        horizontalScroll(scrollState).voxkbScrollbar(scrollState, scrollbarHeight, isVertical = false)
    } else {
        horizontalScroll(scrollState)
    }
}

fun Modifier.voxkbScrollbar(
    state: ScrollState,
