...
package com.voxkb.lib.devtools
...
import com.voxkb.lib.util.TimeUtils
import com.voxkb.lib.util.UnitUtils
...
object Devtools {
    fun generateDebugLog(context: Context, prefs: VoxKBPreferenceModel? = null, includeLogcat: Boolean = false): String {
        return buildString {
    ...
    fun generateDebugLogHeader(context: Context, prefs: VoxKBPreferenceModel? = null): String {
        return buildString {
    ...
    fun generateDebugLogForGithub(context: Context, prefs: VoxKBPreferenceModel? = null, includeLogcat: Boolean = false): String {
        return buildString {
            appendLine("<details>")
    ...
    fun generateAppInfoLog(context: Context, withTitle: Boolean = true): String {
        return buildString {
            ...
            append("Name                : ").appendLine(context.resources.getString(R.string.voxkb_app_name))
    ...
    fun generateFeatureConfigLog(prefs: VoxKBPreferenceModel, withTitle: Boolean = true): String {
        return buildString {
