...
package com.voxkb.lib

import android.content.Context
import com.voxkb.extensionManager
import com.voxkb.lib.VoxKBLocale.Companion.default
import java.util.*
 ...
 *
 * To construct a VoxKBLocale, use one of the many from() methods provided.
 *
 * @see java.util.Locale
 */
@Serializable(with = VoxKBLocale.Serializer::class)
class VoxKBLocale private constructor(val base: Locale) {
    companion object {
        ...
        /**
         * Wraps a [java.util.Locale] and returns the [VoxKBLocale].
         *
         * @return The wrapped locale.
         */
        fun from(javaLocale: Locale) = VoxKBLocale(javaLocale)

        /**
         * Constructs a new [VoxKBLocale] with given [language].
         *
         * @param language A two-letter language code.
         *
         * @return A new [VoxKBLocale].
         */
        fun from(language: String) = from(Locale(language))

        /**
         * Constructs a new [VoxKBLocale] with given [language] and [country].
         *
         * @param language A two-letter language code.
        ...
        /**
         * Constructs a new [VoxKBLocale] with given [language], [country] and [variant].
         *
         * @param language A two-letter language code.
         * @param country A two-letter country code.
        ...
        /**
         * Constructs a new [VoxKBLocale] from given [str].
         *
         ...
         */
        fun default() = VoxKBLocale(Locale.getDefault())
         ...
         */
        fun installedSystemLocales(): List<VoxKBLocale> = Locale.getAvailableLocales().map { from(it) }

        /**
         * Returns a list of all installed locales and custom locales.
         *
         */
        fun extendedAvailableLocales(context: Context): List<VoxKBLocale> {
     ...
     */
    fun displayLanguage(locale: VoxKBLocale = default()): String {
     ...
     */
    fun displayCountry(locale: VoxKBLocale = default()): String = base.getDisplayCountry(locale.base)
     ...
     */
    fun displayVariant(locale: VoxKBLocale = default()): String = base.getDisplayVariant(locale.base)
     ...
     *  [language], [country] and [variant] are not specified.
     */
    fun displayName(locale: VoxKBLocale = default()) = buildString {
     ...
     */
    override fun toString() = "VoxKBLocale { l=${base.language} c=${base.country} v=${base.variant} }"
    ...
    /**
     * The JSON (de)serializer for VoxKBLocale.
     */
    class Serializer : KSerializer<VoxKBLocale> {
        override val descriptor: SerialDescriptor =
            PrimitiveSerialDescriptor("VoxKBLocale", PrimitiveKind.STRING)

        override fun serialize(encoder: Encoder, value: VoxKBLocale) {
            encoder.encodeString(value.languageTag())
        }

        override fun deserialize(decoder: Decoder): VoxKBLocale {
...
inline fun String.lowercase(locale: VoxKBLocale): String = this.lowercase(locale.base)

@Suppress("NOTHING_TO_INLINE")
inline fun String.uppercase(locale: VoxKBLocale): String = this.uppercase(locale.base)

@Suppress("NOTHING_TO_INLINE")
inline fun String.titlecase(locale: VoxKBLocale = VoxKBLocale.ROOT): String {
