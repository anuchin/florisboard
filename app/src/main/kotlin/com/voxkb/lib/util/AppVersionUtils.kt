...
object AppVersionUtils {
    ...
    fun shouldShowChangelog(context: Context, prefs: VoxKBPreferenceModel): Boolean {
        val installVersion =
    ...
    suspend fun updateVersionOnInstallAndLastUse(context: Context, prefs: VoxKBPreferenceModel) {
    ...
    suspend fun updateVersionLastChangelog(context: Context, prefs: VoxKBPreferenceModel) {
