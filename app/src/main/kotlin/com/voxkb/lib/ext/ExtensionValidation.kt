...
object ExtensionValidation {
    ...
    val SnyggStaticColorValue = ValidationRule<String> {
        forKlass = com.voxkb.lib.snygg.value.SnyggStaticColorValue::class
        forProperty = "color"
        validator { input ->
            val str = input.trim()
            when {
                str.isBlank() -> resultInvalid(error = R.string.ext__validation__enter_color)
                com.voxkb.lib.snygg.value.SnyggStaticColorValue.deserialize(str).isFailure -> {
    ...
    val SnyggDpShapeValue = ValidationRule<String> {
        forKlass = com.voxkb.lib.snygg.value.SnyggDpShapeValue::class
        forProperty = "corner"
        validator { str ->
    ...
    val SnyggPercentShapeValue = ValidationRule<String> {
        forKlass = com.voxkb.lib.snygg.value.SnyggPercentShapeValue::class
        forProperty = "corner"
        validator { str ->
