 ...
 * VoxKB's app user interface screens, APK assets, cache and internal
 * storage, external resources provided to VoxKB via content URIs, as
 * well as hyperlinks.
 *
 ...
 */
@Serializable(with = VoxKBRef.Serializer::class)
@JvmInline
value class VoxKBRef private constructor(val uri: Uri) {
    companion object {
        @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE)
        internal const val SCHEME_FLORIS = "voxkb"
        ...
        /**
         * Constructs a new [VoxKBRef] pointing to a UI screen within the app
         * user interface.
         *
        ...
        /**
         * Constructs a new [VoxKBRef] pointing to a resource within the
         * VoxKB APK assets.
         *
         ...
         * destination, regardless of within VoxKB or not.
         *
         * @param uri The destination, denoted by a system URI format.
         *
         * @return The newly constructed reference.
         */
        fun from(uri: Uri) = VoxKBRef(uri)
         ...
         * @return The newly constructed reference.
         */
        fun fromUrl(url: String): VoxKBRef {
            return VoxKBRef(when {
         ...
         * point to any destination, regardless of within VoxKB or not.
         *
    ...
    /**
     * True if the scheme and authority indicates a reference to a VoxKB APK asset
    ...
    /**
     * True if the scheme indicates a reference to a VoxKB cache
     * resource, false otherwise.
     */
    val isCache: Boolean
    ...
    /**
     * True if the scheme indicates a reference to a VoxKB internal
    ...
    /**
     * Returns if this URI contains data for all valid parts of a VoxKBRef.
     */
    val isValid: Boolean
     ...
     *
     * @param assets The lambda to run when the reference points to the VoxKB
     *  screen UI resources. Defaults to do nothing.
     * @param assets The lambda to run when the reference points to the VoxKB
     *  APK assets. Defaults to do nothing.
     * @param cache The lambda to run when the reference points to the VoxKB
     *  cache resources. Defaults to do nothing.
     * @param internal The lambda to run when the reference points to the VoxKB
     ...
     */
    fun whenSchemeIs(
        appUi: (ref: VoxKBRef) -> Unit = { /* Do nothing */ },
        assets: (ref: VoxKBRef) -> Unit = { /* Do nothing */ },
        cache: (ref: VoxKBRef) -> Unit = { /* Do nothing */ },
        internal: (ref: VoxKBRef) -> Unit = { /* Do nothing */ },
        external: (ref: VoxKBRef) -> Unit = { /* Do nothing */ }
    ) {
        contract {
    ...
    object Serializer : PreferenceSerializer<VoxKBRef>, KSerializer<VoxKBRef> {
        override val descriptor = PrimitiveSerialDescriptor("VoxKBRef", PrimitiveKind.STRING)

        override fun serialize(value: VoxKBRef): String {
            return value.toString()
        }

        override fun serialize(encoder: Encoder, value: VoxKBRef) {
            encoder.encodeString(value.toString())
        }

        override fun deserialize(value: String): VoxKBRef {
            return from(value)
        }

        override fun deserialize(decoder: Decoder): VoxKBRef {
