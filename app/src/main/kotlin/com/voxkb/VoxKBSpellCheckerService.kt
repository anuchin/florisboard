...
import com.voxkb.lib.kotlin.map

class VoxKBSpellCheckerService : SpellCheckerService() {
    ...
    override fun createSession(): Session {
        ...
        return VoxKBSpellCheckerSession()
    }
    ...
    private inner class VoxKBSpellCheckerSession : Session() {
        ...
        private fun setupSpellingIfNecessary() {
            val evaluatedSubtype = when (prefs.spelling.languageMode.get()) {
                SpellingLanguageMode.USE_KEYBOARD_SUBTYPES -> {
                    ...
                    Subtype.DEFAULT.copy(primaryLocale = VoxKBLocale.default())
                }
            }
