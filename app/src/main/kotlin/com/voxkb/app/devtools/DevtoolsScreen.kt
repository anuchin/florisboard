...
import com.voxkb.ime.dictionary.VoxKBUserDictionaryDatabase
...
@Composable
fun DevtoolsScreen() = VoxKBScreen {
            ...
            VoxKBConfirmDeleteDialog(
                onConfirm = {
                    DictionaryManager.default().let {
                        ...
                        it.voxkbUserDictionaryDao()?.deleteAll()
                    }
                    setShowDialog(false)
                },
                onDismiss = { setShowDialog(false) },
                what = VoxKBUserDictionaryDatabase.DB_FILE_NAME,
            )
        }
    }
}
