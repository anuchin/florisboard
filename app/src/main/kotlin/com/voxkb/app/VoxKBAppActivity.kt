...
import com.voxkb.R
import com.voxkb.app.apptheme.VoxKBAppTheme
...
class VoxKBAppActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prefs.other.settingsLanguage.asFlow().collectIn(lifecycleScope) {
            ...
            val locale = if (it == "auto") VoxKBLocale.default() else VoxKBLocale.fromTag(it)
