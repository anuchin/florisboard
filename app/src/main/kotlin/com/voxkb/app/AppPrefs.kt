...
import com.voxkb.app.settings.theme.ColorPreferenceSerializer
import com.voxkb.app.settings.theme.DisplayKbdAfterDialogs
import com.voxkb.app.settings.theme.SnyggLevel
import com.voxkb.app.setup.NotificationPermissionState
import com.voxkb.ime.clipboard.CLIPBOARD_HISTORY_NUM_GRID_COLUMNS_AUTO
import com.voxkb.ime.clipboard.ClipboardSyncBehavior
import com.voxkb.ime.core.DisplayLanguageNamesIn
import com.voxkb.ime.core.Subtype
import com.voxkb.ime.input.CapitalizationBehavior
import com.voxkb.ime.input.HapticVibrationMode
import com.voxkb.ime.input.InputFeedbackActivationMode
import com.voxkb.ime.keyboard.IncognitoMode
import com.voxkb.ime.keyboard.SpaceBarMode
import com.voxkb.ime.landscapeinput.LandscapeInputUiMode
import com.voxkb.ime.media.emoji.EmojiHairStyle
import com.voxkb.ime.media.emoji.EmojiHistory
import com.voxkb.ime.media.emoji.EmojiSkinTone
import com.voxkb.ime.media.emoji.EmojiSuggestionType
import com.voxkb.ime.nlp.SpellingLanguageMode
import com.voxkb.ime.smartbar.CandidatesDisplayMode
import com.voxkb.ime.smartbar.ExtendedActionsPlacement
import com.voxkb.ime.smartbar.IncognitoDisplayMode
import com.voxkb.ime.smartbar.SmartbarLayout
import com.voxkb.ime.smartbar.quickaction.QuickAction
import com.voxkb.ime.smartbar.quickaction.QuickActionArrangement
import com.voxkb.ime.smartbar.quickaction.QuickActionJsonConfig
import com.voxkb.ime.text.gestures.SwipeAction
import com.voxkb.ime.text.key.KeyCode
import com.voxkb.ime.text.key.KeyHintConfiguration
import com.voxkb.ime.text.key.KeyHintMode
import com.voxkb.ime.text.key.UtilityKeyAction
...
import com.voxkb.ime.theme.extCoreTheme
import com.voxkb.ime.window.ImeWindowConfig
import com.voxkb.lib.ext.ExtensionComponentName
import com.voxkb.lib.util.VersionName
...
import com.voxkb.lib.android.isOrientationPortrait

val VoxKBPreferenceStore = jetprefDataStoreOf(VoxKBPreferenceModel::class)

@Preferences
abstract class VoxKBPreferenceModel : PreferenceModel() {
    companion object {
        const val NAME = "voxkb-app-prefs"
    }
    ...
    inner class Clipboard {
        ...
        val syncToVoxKB = enum(
            key = "clipboard__sync_to_voxkb",
    ...
    inner class Dictionary {
        ...
        val enableVoxKBUserDictionary = boolean(
            key = "suggestion__enable_voxkb_user_dictionary",
            default = true,
        )
    }
    ...
    inner class Keyboard {
        ...
        val coderToolbarEnabled = boolean(
            key = "keyboard__coder_toolbar_enabled",
            default = false,
        )
    ...
    inner class Theme {
        ...
        val dayThemeId = custom(
            ...
            default = extCoreTheme("voxkb_day"),
            serializer = ExtensionComponentName.Serializer,
        )
        val nightThemeId = custom(
            key = "theme__night_theme_id",
            default = extCoreTheme("voxkb_night"),
            serializer = ExtensionComponentName.Serializer,
        )
        val accentColor = custom(
        ...
        return when (entry.key) {
            ...
            "media__emoji_recently_used" -> {
                ...
                val recent = emojiValues.map {
                    com.voxkb.ime.media.emoji.Emoji(it, "", emptyList())
                }
            ...
            // Keep migration rules until: 0.7 dev cycle
            "clipboard__sync_to_voxkb", "clipboard__sync_to_system" -> {
                entry.transform(
