...
@Composable
fun DictionaryScreen() = VoxKBScreen {
    ...
    content {
        ...
        SwitchPreference(
            prefs.dictionary.enableVoxKBUserDictionary,
        ...
        Preference(
            title = stringRes(R.string.pref__dictionary__manage_voxkb_user_dictionary__label),
            summary = stringRes(R.string.pref__dictionary__manage_voxkb_user_dictionary__summary),
            onClick = { navController.navigate(Routes.Settings.UserDictionary(UserDictionaryType.FLORIS)) },
            enabledIf = { prefs.dictionary.enableVoxKBUserDictionary isEqualTo true },
        )
    }
}
