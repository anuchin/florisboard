...
package com.voxkb.app.settings.typing
...
import com.voxkb.lib.compose.VoxKBErrorCard
import com.voxkb.lib.compose.stringRes

@OptIn(ExperimentalJetPrefDatastoreUi::class)
@Composable
fun TypingScreen() = VoxKBScreen {
    ...
    content {
                ...
                Card(modifier = Modifier.padding(8.dp)) {
                    Column(modifier = Modifier.padding(8.dp)) {
                        ...
                        VoxKBHyperlinkText(
                            ...
                            url = "https://github.com/voxkb/voxkb/discussions/1935",
                        )
                    }
                }
            }
        ...
        PreferenceGroup(title = stringRes(R.string.pref__spelling__title)) {
            val voxkbSpellCheckerEnabled = remember { mutableStateOf(false) }
            SpellCheckerServiceSelector(voxkbSpellCheckerEnabled)
            ListPreference(
                ...
                enabledIf = { voxkbSpellCheckerEnabled.value },
            )
            SwitchPreference(
