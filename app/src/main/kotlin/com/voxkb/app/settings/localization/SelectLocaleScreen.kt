...
@Composable
fun SelectLocaleScreen() = VoxKBScreen {
    ...
    val systemLocales =
        VoxKBLocale.extendedAvailableLocales(context).sortedBy { locale ->
        ...
        if (searchTermValue.text.isBlank()) {
            ...
            systemLocales.filter { locale ->
                locale.displayName().lowercase().contains(term) ||
                    ...
                    locale.displayName(VoxKBLocale.ENGLISH).lowercase().contains(term) ||
    ...
    content {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            LazyColumn(
                modifier = Modifier
                    .weight(1f)
                    .voxkbScrollbar(state, isVertical = true),
                state = state,
            ) {
