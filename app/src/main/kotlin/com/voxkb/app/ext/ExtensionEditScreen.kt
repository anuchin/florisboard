...
import com.voxkb.app.settings.advanced.RadioListItem
import com.voxkb.app.settings.theme.DialogProperty
import com.voxkb.app.settings.theme.PrettyPrintConfig
import com.voxkb.app.settings.theme.ThemeEditorScreen
import com.voxkb.cacheManager
import com.voxkb.extensionManager
import com.voxkb.ime.keyboard.KeyboardExtension
import com.voxkb.ime.theme.ThemeExtension
import com.voxkb.ime.theme.ThemeExtensionComponent
import com.voxkb.ime.theme.ThemeExtensionComponentEditor
import com.voxkb.ime.theme.ThemeExtensionComponentImpl
import com.voxkb.ime.theme.ThemeExtensionEditor
import com.voxkb.lib.ValidationResult
import com.voxkb.lib.cache.CacheManager
import com.voxkb.lib.compose.VoxKBScreen
import com.voxkb.lib.compose.VoxKBUnsavedChangesDialog
import com.voxkb.lib.compose.Validation
import com.voxkb.lib.ext.Extension
import com.voxkb.lib.ext.ExtensionComponent
import com.voxkb.lib.ext.ExtensionComponentName
import com.voxkb.lib.ext.ExtensionDefaults
import com.voxkb.lib.ext.ExtensionEditor
import com.voxkb.lib.ext.ExtensionJsonConfig
import com.voxkb.lib.ext.ExtensionMaintainer
import com.voxkb.lib.ext.ExtensionManager
import com.voxkb.lib.ext.ExtensionMeta
import com.voxkb.lib.ext.ExtensionValidation
import com.voxkb.lib.ext.validate
import com.voxkb.lib.io.VoxKBRef
import com.voxkb.lib.io.ZipUtils
import com.voxkb.lib.rememberValidationResult
import com.voxkb.themeManager
import dev.patrickgold.jetpref.datastore.ui.Preference
import dev.patrickgold.jetpref.material.ui.JetPrefAlertDialog
import dev.patrickgold.jetpref.material.ui.JetPrefTextField
import java.util.*
import com.voxkb.lib.compose.VoxKBButtonBar
import com.voxkb.lib.compose.VoxKBIconButton
import com.voxkb.lib.compose.VoxKBInfoCard
...
import com.voxkb.lib.kotlin.io.subDir
import com.voxkb.lib.kotlin.io.subFile
import com.voxkb.lib.kotlin.io.writeJson
...
private fun EditScreen(
    ...
    val extEditor = workspace.editor ?: return@VoxKBScreen
    ...
    fun handleSave() {
        ...
        val sourceRef = if (isCreateExt) {
            VoxKBRef.internal(ExtensionManager.IME_THEME_PATH).subRef(flexArchiveName)
        } else {
...
private fun ManageMetaDataScreen(
    ...
    val meta = workspace.editor?.meta ?: return@VoxKBScreen
...
@Composable
private fun ManageDependenciesScreen(workspace: CacheManager.ExtEditorWorkspace<*>) = VoxKBScreen {
    title = stringRes(R.string.ext__editor__dependencies__title)

    val dependencyList = workspace.editor?.dependencies ?: return@VoxKBScreen
