...
private fun RowScope.StickyModifierButton(
    ...
    var isPressed by remember { mutableStateOf(false) }
    // Active sticky modifiers reuse the PRESSED (primary fill) treatment so the
    // active state is theme-driven rather than a hardcoded Color literal.
    val selector = when {
        isActive -> SnyggSelector.PRESSED
