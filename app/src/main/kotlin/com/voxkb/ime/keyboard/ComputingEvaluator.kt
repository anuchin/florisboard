...
import com.voxkb.lib.compose.vectorResource
import com.voxkb.lib.compose.icons.ForwardDelete
...
interface ComputingEvaluator {
    ...
    val editorInfo: VoxKBEditorInfo
...
object DefaultComputingEvaluator : ComputingEvaluator {
    ...
    override val editorInfo = VoxKBEditorInfo.Unspecified
...
private var cachedDisplayNameState = Triple(VoxKBLocale.ROOT, DisplayLanguageNamesIn.SYSTEM_LOCALE, "")
 ...
 */
private fun computeLanguageDisplayName(locale: VoxKBLocale, displayLanguageNamesIn: DisplayLanguageNamesIn): String {
...
fun ComputingEvaluator.computeImageVector(data: KeyData): ImageVector? {
    ...
    return when (data.code) {
        ...
        KeyCode.TOGGLE_FLOATING_WINDOW -> {
            ...
            val windowController = VoxKBImeService.windowControllerOrNull() ?: return enabledIcon
