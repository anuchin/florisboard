...
package com.voxkb.ime.keyboard
...
import com.voxkb.ime.core.SubtypePreset
import com.voxkb.ime.editor.EditorContent
import com.voxkb.ime.editor.VoxKBEditorInfo
import com.voxkb.ime.editor.ImeOptions
import com.voxkb.ime.editor.InputAttributes
...
import com.voxkb.ime.input.InputKeyEventReceiver
import com.voxkb.ime.input.InputShiftState
import com.voxkb.ime.nlp.ClipboardSuggestionCandidate
import com.voxkb.ime.nlp.PunctuationRule
import com.voxkb.ime.nlp.SuggestionCandidate
import com.voxkb.ime.popup.PopupMappingComponent
import com.voxkb.ime.text.composing.Composer
...
import com.voxkb.ime.text.keyboard.TextKeyboardCache
...
import com.voxkb.lib.titlecase
import com.voxkb.lib.uppercase
import com.voxkb.lib.util.InputMethodUtils
import com.voxkb.nlpManager
import com.voxkb.subtypeManager
...
import com.voxkb.lib.android.showLongToast
...
import com.voxkb.lib.kotlin.collectLatestIn
...
class KeyboardManager(context: Context) : InputKeyEventReceiver {
    ...
    fun executeSwipeAction(swipeAction: SwipeAction) {
        val keyData = when (swipeAction) {
            ...
            SwipeAction.SWITCH_TO_VOICE_CONTEXT -> TextKeyData.VOICE_INPUT
    ...
    private fun handleLanguageSwitch() {
        when (prefs.keyboard.utilityKeyAction.get()) {
            ...
            else -> VoxKBImeService.switchToNextInputMethod()
        }
    }
        ...
        lastToastReference = WeakReference(
            if (newState) {
                appContext.showLongToast(
                    ...
                    "app_name" to appContext.getString(R.string.voxkb_app_name),
                )
            } else {
                appContext.showLongToast(
    ...
    override fun onInputKeyDown(data: KeyData) {
        val windowController = VoxKBImeService.windowControllerOrNull()
    ...
    override fun onInputKeyUp(data: KeyData) = activeState.batchEdit {
        val windowController = VoxKBImeService.windowControllerOrNull() ?: return@batchEdit
        when (data.code) {
            KeyCode.ARROW_DOWN,
            KeyCode.ARROW_LEFT,
            KeyCode.ARROW_RIGHT,
            ...
            KeyCode.ESCAPE -> editorInstance.sendDownUpKeyEvent(KeyEvent.KEYCODE_ESCAPE)
            ...
            KeyCode.TAB -> editorInstance.sendDownUpKeyEvent(KeyEvent.KEYCODE_TAB)
            KeyCode.IME_SHOW_UI -> VoxKBImeService.showUi()
            KeyCode.IME_HIDE_UI -> VoxKBImeService.hideUi()
            ...
            KeyCode.SETTINGS -> VoxKBImeService.launchSettings()
            ...
            KeyCode.SYSTEM_PREV_INPUT_METHOD -> VoxKBImeService.switchToPrevInputMethod()
            KeyCode.SYSTEM_NEXT_INPUT_METHOD -> VoxKBImeService.switchToNextInputMethod()
    ...
    override fun onInputKeyRepeat(data: KeyData) {
        VoxKBImeService.inputFeedbackController()?.keyRepeatedAction(data)
        when (data.code) {
            KeyCode.ARROW_DOWN,
            KeyCode.ARROW_LEFT,
            KeyCode.ARROW_RIGHT,
    ...
    private inner class ComputingEvaluatorImpl(
        ...
        override val editorInfo: VoxKBEditorInfo,
