...
import com.voxkb.lib.snygg.ui.ProvideSnyggTheme
import com.voxkb.lib.snygg.ui.rememberSnyggTheme

@Composable
fun VoxKBImeTheme(content: @Composable () -> Unit) {
    ...
    val assetResolver = remember(activeThemeInfo) {
        VoxKBAssetResolver(context, activeThemeInfo)
    }
    ...
    val attributes = mapOf(
        VoxKBImeUi.Attr.Mode to state.keyboardMode.toString(),
        VoxKBImeUi.Attr.ShiftState to state.inputShiftState.toString(),
    )
