...
import com.voxkb.ime.nlp.EmojiSuggestionCandidate
...
class EmojiSuggestionProvider(private val context: Context) : SuggestionProvider {
    override val providerId = "com.voxkb.nlp.providers.emoji"

    private val prefs by VoxKBPreferenceStore
    private val lettersRegex = "^[A-Za-z]*$".toRegex()

    private val cachedEmojiMappings = Cache.Builder<VoxKBLocale, EmojiDataBySkinTone>().build()
