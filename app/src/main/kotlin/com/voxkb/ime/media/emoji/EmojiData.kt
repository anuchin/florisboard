...
import com.voxkb.lib.android.bufferedReader
...
data class EmojiData(
    ...
    companion object {
        ...
        suspend fun get(context: Context, locale: VoxKBLocale): EmojiData {
         ...
         */
        private fun resolveEmojiAssetPath(context: Context, locale: VoxKBLocale): String? {
