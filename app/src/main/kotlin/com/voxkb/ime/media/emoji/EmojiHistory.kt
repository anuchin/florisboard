/*
 * Copyright (C) 2024-2025 The VoxKB Contributors
 *
...
object EmojiHistoryHelper {
    ...
    suspend fun markEmojiUsed(prefs: VoxKBPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
    ...
    suspend fun pinEmoji(prefs: VoxKBPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
    ...
    suspend fun unpinEmoji(prefs: VoxKBPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
    ...
    suspend fun moveEmoji(prefs: VoxKBPreferenceModel, emoji: Emoji, offset: Int): Unit = emojiGuard.withLock {
    ...
    suspend fun removeEmoji(prefs: VoxKBPreferenceModel, emoji: Emoji): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
    ...
    suspend fun deleteHistory(prefs: VoxKBPreferenceModel): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
        val dataMut = prefs.emoji.historyData.get().edit()
    ...
    suspend fun deletePinned(prefs: VoxKBPreferenceModel): Unit = emojiGuard.withLock {
        if (!prefs.emoji.historyEnabled.get()) {
            return
        }
        val dataMut = prefs.emoji.historyData.get().edit()
