...
import com.voxkb.ime.media.emoji.EmojiData
import com.voxkb.ime.media.emoji.EmojiPaletteView
...
fun MediaInputLayout(
    ...
    SnyggColumn(
        elementName = VoxKBImeUi.Media.elementName,
        modifier = modifier
            .fillMaxWidth()
        ...
        SnyggRow(
            elementName = VoxKBImeUi.MediaBottomRow.elementName,
            modifier = Modifier
                .fillMaxWidth()
                .height(VoxKBImeSizing.keyboardRowBaseHeight * 0.8f),
        ) {
            KeyboardLikeButton(
                elementName = VoxKBImeUi.MediaBottomRowButton.elementName,
...
internal fun KeyboardLikeButton(
    ...
    keyData: KeyData,
    elementName: String = VoxKBImeUi.MediaEmojiKey.elementName,
