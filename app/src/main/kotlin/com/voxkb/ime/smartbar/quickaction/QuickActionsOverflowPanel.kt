...
fun QuickActionsOverflowPanel() {
    ...
    SnyggBox(
        elementName = VoxKBImeUi.SmartbarActionsOverflow.elementName,
        modifier = Modifier
            .fillMaxWidth()
        ...
        LazyVerticalGrid(
            modifier = Modifier
                .fillMaxWidth(),
            columns = GridCells.Adaptive(VoxKBImeSizing.smartbarHeight.coerceAtLeast(1.dp) * 2.2f),
        ) {
            ...
            item(span = { GridItemSpan(maxLineSpan) }) {
                SnyggButton(
                    elementName = VoxKBImeUi.SmartbarActionsOverflowCustomizeButton.elementName,
