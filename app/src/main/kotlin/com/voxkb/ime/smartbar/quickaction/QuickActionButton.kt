...
fun QuickActionButton(
    ...
    val elementName = when (type) {
        QuickActionBarType.INTERACTIVE_BUTTON -> VoxKBImeUi.SmartbarActionKey
        QuickActionBarType.INTERACTIVE_TILE -> VoxKBImeUi.SmartbarActionTile
        QuickActionBarType.EDITOR_TILE -> VoxKBImeUi.SmartbarActionsEditorTile
    }.elementName
    val attributes = mapOf(VoxKBImeUi.Attr.Code to action.keyData().code)
    val selector = when {
