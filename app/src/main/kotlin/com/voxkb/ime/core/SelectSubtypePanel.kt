...
import com.voxkb.lib.snygg.ui.SnyggListItem
...
fun SelectSubtypePanel(modifier: Modifier = Modifier) {
    ...
    SnyggColumn(VoxKBImeUi.SubtypePanel.elementName, modifier = modifier.safeDrawingPadding()) {
        SnyggRow(
            elementName = VoxKBImeUi.SubtypePanelHeader.elementName,
        ...
        SnyggBox(VoxKBImeUi.SubtypePanelList.elementName) {
            LazyColumn(
                state = listState,
            ) {
                items(
                    ...
                    SnyggListItem(
                        elementName = VoxKBImeUi.SubtypePanelListItem.elementName,
                        onClick = {
