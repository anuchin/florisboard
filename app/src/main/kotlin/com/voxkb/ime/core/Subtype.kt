...
package com.voxkb.ime.core

import com.voxkb.ime.keyboard.LayoutType
import com.voxkb.ime.keyboard.LayoutTypeId
import com.voxkb.ime.keyboard.extCoreComposer
import com.voxkb.ime.keyboard.extCoreCurrencySet
import com.voxkb.ime.keyboard.extCoreLayout
import com.voxkb.ime.keyboard.extCorePopupMapping
import com.voxkb.ime.keyboard.extCorePunctuationRule
...
data class Subtype(
    val id: Long,
    val primaryLocale: VoxKBLocale,
    val secondaryLocales: List<VoxKBLocale>,
    ...
    companion object {
        ...
        val DEFAULT = Subtype(
            id = -1,
            primaryLocale = VoxKBLocale.from("en", "US"),
