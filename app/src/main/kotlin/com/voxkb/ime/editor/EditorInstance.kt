...
class EditorInstance(context: Context) : AbstractEditorInstance(context) {
    ...
    private fun currentInputConnection() = VoxKBImeService.currentInputConnection()

    override fun handleStartInputView(editorInfo: VoxKBEditorInfo, isRestart: Boolean) {
    ...
    override fun shouldDetermineComposingRegion(editorInfo: VoxKBEditorInfo): Boolean {
