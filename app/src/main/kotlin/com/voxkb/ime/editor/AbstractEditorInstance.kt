...
import com.voxkb.ime.nlp.BreakIteratorGroup
...
import com.voxkb.lib.kotlin.guardedByLock
...
abstract class AbstractEditorInstance(context: Context) {
    ...
    private val _activeInfoFlow = MutableStateFlow(VoxKBEditorInfo.Unspecified)
    val activeInfoFlow = _activeInfoFlow.asStateFlow()
    inline var activeInfo: VoxKBEditorInfo
    ...
    open fun handleStartInput(editorInfo: VoxKBEditorInfo) {
    ...
    open fun handleStartInputView(editorInfo: VoxKBEditorInfo, isRestart: Boolean) {
        if (isRestart) {
    ...
    protected open fun reset() {
        activeInfo = VoxKBEditorInfo.Unspecified
        activeCursorCapsMode = InputAttributes.CapsMode.NONE
        activeContent = EditorContent.Unspecified
    ...
    private suspend fun EditorContent.generateCopy(
        editorInfo: VoxKBEditorInfo = activeInfo,
    ...
    protected open fun shouldDetermineComposingRegion(editorInfo: VoxKBEditorInfo): Boolean {
