...
class VoxKBEditorInfo private constructor(val base: EditorInfo) {
    ...
    companion object {
        val Unspecified = VoxKBEditorInfo(EditorInfo())

        fun wrap(editorInfo: EditorInfo) = VoxKBEditorInfo(editorInfo)
    }
}
