...
fun rememberPopupUiController(
    key1: Any?,
    key2: Any?,
    boundsProvider: (key: Key) -> VoxKBRect,
...
class PopupUiController(
    val context: Context,
    val boundsProvider: (key: Key) -> VoxKBRect,
