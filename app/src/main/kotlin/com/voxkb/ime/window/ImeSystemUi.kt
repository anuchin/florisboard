/*
 * Copyright (C) 2021-2026 The VoxKB Contributors
 *
...
import com.voxkb.lib.snygg.ui.uriOrNull
...
fun ImeSystemUi() {
    ...
    val backgroundQuery = rememberSnyggThemeQuery(VoxKBImeUi.Window.elementName)
        ...
        Row(
            ...
            if (!showHideAndSwitch) {
                Box(
                    ...
                    VoxKBIconButton(
                        onClick = {
                            VoxKBImeService.switchToNextInputMethod()
                        },
                        onLongClick = {
                            VoxKBImeService.showImePicker()
                        }
                    ) {
...
private fun RowScope.NavigationPill() {
    ...
    val style = rememberSnyggThemeQuery(VoxKBImeUi.WindowMoveHandle.elementName, attributes)
