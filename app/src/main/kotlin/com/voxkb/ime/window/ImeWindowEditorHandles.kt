...
import com.voxkb.lib.compose.toDp
...
private fun ImeWindowResizeHandle(
    ...
    val style = rememberSnyggThemeQuery(VoxKBImeUi.WindowResizeHandle.elementName, attributes)
...
fun BoxScope.ImeWindowResizeHandlesFixed() {
    ...
    val attributes = remember(windowConfig.mode) {
        mapOf(
            VoxKBImeUi.Attr.WindowMode to windowConfig.mode
        )
    }

    val overlayStyle = rememberSnyggThemeQuery(VoxKBImeUi.WindowResizeOverlayFixed.elementName)
    ...
    if (visible) {
        ...
        Row(
            ...
            SnyggIconButton(
                elementName = VoxKBImeUi.WindowResizeAction.elementName,
            ...
            SnyggIconButton(
                VoxKBImeUi.WindowMoveHandle.elementName,
                attributes = attributes,
                onClick = {}
            ) {
                SnyggIcon(
                    elementName = VoxKBImeUi.WindowMoveHandle.elementName,
...
private fun Modifier.imeWindowEditorHandle(
    ...
    val rowCount by VoxKBImeSizing.rowCountAsState()
    val smartbarRowCount by VoxKBImeSizing.smartbarRowCountAsState()
    Modifier
        .pointerInput(Unit) {
            detectTapGestures {
                onTap()
